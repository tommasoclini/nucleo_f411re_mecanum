...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(FL_ENCODER_A_GPIO_Port, FL_ENCODER_A_Pin);

    HAL_GPIO_DeInit(FL_ENCODER_B_GPIO_Port, FL_ENCODER_B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB4     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(FR_ENCODER_B_GPIO_Port, FR_ENCODER_B_Pin);

    HAL_GPIO_DeInit(FR_ENCODER_A_GPIO_Port, FR_ENCODER_A_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, BL_ENCODER_A_Pin|BL_ENCODER_B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, BR_ENCODER_A_Pin|BR_ENCODER_B_Pin);
